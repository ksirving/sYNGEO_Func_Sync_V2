...
### output_data from scripts 02 & 3a & 3b are saved into output_data/sync under .gitignore
...
some NAs in df, from where correaltion couldn't be calculated in script 02a/b
